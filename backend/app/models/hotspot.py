...
class Hotspot(Base):
    ...
    name = Column(String(200), nullable=True, index=True, comment="Hotspot name identifier")
    mac = Column(String(200), nullable=True, index=True, comment="MAC address or IP address")
    geocode = Column(String(200), nullable=True, comment="Geographic coordinates or location code")
    type = Column(String(200), nullable=True, comment="Hotspot type or category")
    
    # Owner information
    owner = Column(String(200), nullable=True, comment="Owner name")
    email_owner = Column(String(200), nullable=True, comment="Owner email address")
    
    # Manager information
    manager = Column(String(200), nullable=True, comment="Manager name")
    email_manager = Column(String(200), nullable=True, comment="Manager email address")
    ...
    phone2 = Column(String(200), nullable=True, comment="Secondary phone number")
    
    # Company information
    company = Column(String(200), nullable=True, comment="Company name")
    companywebsite = Column(String(200), nullable=True, comment="Company website URL")
    companyemail = Column(String(200), nullable=True, comment="Company email address")
    companycontact = Column(String(200), nullable=True, comment="Company contact person")
    companyphone = Column(String(200), nullable=True, comment="Company phone number")
    
    # Audit fields
    creationdate = Column(DateTime, default=func.now(), comment="Creation timestamp")
    creationby = Column(String(128), nullable=True, comment="Created by operator")
    updatedate = Column(DateTime, default=func.now(), onupdate=func.now(), comment="Last update timestamp")
    updateby = Column(String(128), nullable=True, comment="Last updated by operator")
