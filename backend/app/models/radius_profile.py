...
class ProfileUsage(BaseModel):
    ...
    __table_args__ = (
        ...
        UniqueConstraint('profile_id', 'entity_type', 'entity_name', name='uq_profile_usage'),
    )
...
RadiusProfile.usages = relationship("ProfileUsage", back_populates="profile", cascade="all, delete-orphan")
