...
class GeoLocationService:
    ...
    def _init_geoip_database(self):
        ...
        try:
            ...
            if not self.geoip_reader:
                self.logger.warning("GeoIP database not found. Download GeoLite2-City.mmdb from MaxMind")
    ...
    def get_ip_location(self, ip_address: str) -> Optional[Dict[str, Any]]:
        ...
        if self.geoip_reader:
            try:
                ...
                self.logger.debug(f"IP {ip_address} not found in GeoIP database")
            except Exception as e:
    ...
    def get_nearby_cities(self, 
        ...
        self.logger.info(f"Nearby cities search requested for {latitude},{longitude} within {radius_km}km")
        return []
