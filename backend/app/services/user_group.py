...
class UserGroupService:
    ...
    async def get_user_groups_detailed(self, username: str) -> Dict[str, Any]:
        ...
        highest_priority = max([g["priority"] for g in groups_with_details], default=0)
        lowest_priority = min([g["priority"] for g in groups_with_details], default=0)
    ...
    async def get_comprehensive_statistics(self) -> Dict[str, Any]:
        ...
        if basic_stats["total_groups"] > 0:
            avg_users_per_group = basic_stats["total_associations"] / basic_stats["total_groups"]
        else:
        ...
        for i, operation in enumerate(operations):
            ...
            try:
                ...
                if action == "add":
                    ...
                    op_result["message"] = str(result) if not success else "Added successfully"
